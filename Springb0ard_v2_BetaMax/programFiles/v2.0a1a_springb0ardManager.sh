...
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a1a_springb0ardManager.sh # CORE FUNCTION
...
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a4a_addScp3r.sh #ADDED# Depreciated? if not # alias= install-scp3r
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a4b_Scp3r.sh #ADDED# alias= scp3r
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a4c_qscp.sh #ADDED# alias= qscp
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a4d_cronTabAutomation.sh #ADDED# alias= add-cron
...
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a5c_yatGitAddAcct.sh #ADDED# alias= add-origin
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a7a_gitInstallPostfix.sh #ADDED# alias= install-email-server
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a7b_gitPostfix.DKIM.sh #ADDED# alias= install-email-dkim
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a7c_gitBasicWebServer.sh #ADDED# alias= install-webserver
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a7d_gitConfigBscWebServer.sh #ADDED# alias= config-webserver
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.0a7e_gitDeployLandingPage.sh #ADDED# alias= deploy-landing-page
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.1b0a_emailRootIni.sh # Depreciated
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/programFiles/v2.1c0a_gitEmailRoot.sh # CORE FUNCTION
# dTools
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/dTools/microInit_i1.sh # alias= dude
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/dTools/microInit_v0.0.sh # alias= sudo-dude
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/dTools/Q_Com.sh # alias= commit
sudo chmod +x cd /etc/springb0ard/Springb0ard/Springb0ard_v2_BetaMax/dTools/SQ_Com_v0.0.sh # alias= sudo-commit
# Aliases
